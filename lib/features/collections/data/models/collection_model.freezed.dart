...
class _$CollectionModelImpl implements _CollectionModel {
  ...
  @override
  String toString() {
    return 'CollectionModel(id: $id, title: $title, description: $description, coverImageUrl: $coverImageUrl, creatorId: $creatorId, isPremium: $isPremium, sectionCount: $sectionCount, createdAt: $createdAt)';
  }
...
abstract class _CollectionModel implements CollectionModel {
  const factory _CollectionModel(
      ...
      required final DateTime createdAt}) = _$CollectionModelImpl;
